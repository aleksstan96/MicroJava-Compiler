...
import rs.ac.bg.etf.pp1.ast.AddOpTermListOne;
import rs.ac.bg.etf.pp1.ast.ArrayIdent;
import rs.ac.bg.etf.pp1.ast.CnstDecl;
import rs.ac.bg.etf.pp1.ast.ConstTypeBool;
import rs.ac.bg.etf.pp1.ast.ConstTypeChar;
import rs.ac.bg.etf.pp1.ast.ConstTypeNum;
...
import rs.ac.bg.etf.pp1.ast.DesignatorScalar;
import rs.ac.bg.etf.pp1.ast.ExprNoMinus;
import rs.ac.bg.etf.pp1.ast.ExprWithMinus;
...
import rs.ac.bg.etf.pp1.ast.FactorNewExprExists;
...
import rs.ac.bg.etf.pp1.ast.MulopFactorListOneElem;
...
import rs.ac.bg.etf.pp1.ast.VDeclArr;
import rs.ac.bg.etf.pp1.ast.VDeclNoArr;
...
//	boolean returnExists = false;
	...
	/*
	 * public void report_symbol_info(String message, Obj obj) { SymbolTableVisitor
	 * stv = new SymTableVisitorBoolean(); obj.accept(stv); StringBuilder msg = new
	 * StringBuilder(message); msg.append(".  ");
	...
	public SemanticAnalyzer() {
		...
		Tab.currentScope.addToLocals(new Obj(Obj.Type, "bool", new Struct(Struct.Bool))); //dodajemo bool tip u program scope
	}
...
//	}
	...
	public void visit(MulopFactorListOneElem m) {
		m.struct = m.getFactor().struct;
	}

	public void visit(MulopFactorListRecursive ml) {

		Struct factorType = ml.getFactor().struct;
		Struct factorListType = ml.getMulopFactorList().struct;
...
//			report_error("Operand uz - mora da bude tipa int!", exprMinus);
